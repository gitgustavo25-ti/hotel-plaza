...
$encodedMessage = urlencode($message);
    ...
    $whatsappLink = "https://api.whatsapp.com/send?phone=55{$row['phone']}&text={$encodedMessage}";
          ...
          <tr>
            ...
            <td style="text-align: center; vertical-align: middle;" class="text-center">
                <?php if ($rows['aprovacao'] === 'pendente') : ?>
                    <a href="reservations.php?delete=<?= $rows['id']; ?>" class="w3-btn w3-small w3-red" title="Cancelar Reserva">
                        <span class="glyphicon glyphicon-trash"></span>
                    </a>
                <?php endif; ?>
                
                <?php if ($rows['aprovacao'] === 'aprovado') : ?>
                    <a href="reservations.php?whatsapp=<?= $rows['id']; ?>" class="w3-btn w3-small w3-green" target="_blank" title="Entrar em contato via WhatsApp">
                ...
                <?php // NOVO: Adicionado para status 'cancelado' e 'reprovado' ?>
                <?php if ($rows['aprovacao'] === 'cancelado' || $rows['aprovacao'] === 'reprovado') : ?>
                    <span class="glyphicon glyphicon-remove" style="color: #d9534f; font-size: 1.8em;" title="Reserva não efetivada"></span>
                <?php endif; ?>
            </td>
          </tr>
        <?php endwhile; ?>
