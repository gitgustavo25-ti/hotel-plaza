...
<body style="background-color: #343a4a; color:white">
  ...
  <div id="index-banner" class="parallax-container">
    ...
    <div class="parallax custom-parallax">
      <img src="img/foto.jpg" alt="" class="custom-parallax-image" style="max-width: 1%;">
      <img src="img/foto2.jpg" alt="" class="custom-parallax-image" style="max-width: 1%;">
      <img src="img/foto3.jpg" alt="" class="custom-parallax-image" style="max-width: 1%;">
      <img src="img/foto4.jpg" alt="" class="custom-parallax-image" style="max-width: 1%;">
    </div>
    ...
    <div class="section">
        <div class="row">
            <div class="col s12 m4">
                <div class="icon-block">
                    ...
                    <p class="light">
                        Aqui no <u><a style="color: white; font-weight: bold" href="index.php">Hotel-Plaza</a></u>, você encontra as melhores estadias, pensadas ex- cluivamente para você. Desfrute já dessa experiência!
                    </p>
                </div>
            </div>
            <div class="col s12 m4">
     ...
     <div class="col s12 m4">
        ...
        <div class="valign-wrapper"> <!-- Adicione a classe valign-wrapper aqui -->
            <p class="light">
                Satisfaça seu paladar com opções cuidadosamente selecionadas.
            </p>
        </div>
    </div>
</div>
			...
			<div class="row">
				<div class="col l6 s12" style="margin-left:80px">
					...
					<p class="grey-text text-lighten-4" style="margin-left: 280px">
						<b style="font-size:22px;">Hotel Plaza</b> <br>
                        Av. Brig. Luis Antônio, 277 Paraíso - São Paulo - SP<br />
						Cel: (32) 99122-7742
					</p>
				</div>
